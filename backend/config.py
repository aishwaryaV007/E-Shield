...
#    - Expose DB_PATH, DATA_DIR, MODEL_DIR, CORPUS_DIR, CORS_ORIGINS, LOG_LEVEL with sensible defaults.
#    - MODEL_DIR holds both the cached embedding model and the trained mark-predictor artifact.
...
# 5. DEPENDS ON / USED BY: pydantic-settings; used by main.py, api/deps.py, storage/db.py, models/*, training/*.
