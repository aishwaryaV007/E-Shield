...
todos = {
    ...
    "DATABASE_DESIGN.md": [
        ...
        "[x] Implement CRUD operations in db.py"
    ],
    "DATA_FLOW.md": [
    ...
    "FUTURE_IMPLEMENTATION_TASKS.md": [
        "[ ] Prioritize backlog items",
        "[ ] Assign remaining tasks to milestones"
    ],
    "HOW_TO_RUN.md": [
    ...
    "SCALABILITY.md": [
        "[ ] Implement caching layer for model predictions",
        "[ ] Design for horizontal scaling of OCR tasks"
    ],
    "SECRETS.md": [
